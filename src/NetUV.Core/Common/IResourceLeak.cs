...
namespace NetUV.Core.Common
{
    public interface IResourceLeak
    {
        ...
        /// can tell where the leaked resource was accessed lastly. This method is a shortcut to 
        /// <see cref="Record(object)" /> with <c>null</c> as an argument.
        /// </summary>
        void Record();
        ...
        /// </summary>
        /// <param name="hint">The hint object</param>
