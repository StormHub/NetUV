...
namespace NetUV.Core.Tests.Buffers
{
    ...
    public abstract class AbstractByteBufferTests : IDisposable
    {
        ...
        internal IByteBuffer NewBuffer(int capacity) => this.NewBuffer(capacity, int.MaxValue);

        internal abstract IByteBuffer NewBuffer(int capacity, int maxCapacity);
        ...
        internal IByteBuffer ReleaseLater(IByteBuffer buf)
        {
