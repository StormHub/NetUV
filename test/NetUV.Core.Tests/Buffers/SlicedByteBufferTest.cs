...
namespace NetUV.Core.Tests.Buffers
{
    ...
    {
        internal sealed override IByteBuffer NewBuffer(int length, int maxCapacity)
        {
        ...
        internal virtual IByteBuffer NewSlice(IByteBuffer buffer, int offset, int length) => buffer.Slice(offset, length);
